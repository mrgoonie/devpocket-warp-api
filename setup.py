...
class DevPocketSetup:
    ...
    def check_python_version(self) -> bool:
        ...
        if version.major != 3 or version.minor < 11:
            self.log(f"Python 3.11+ required, found {version.major}.{version.minor}", "ERROR")
            return False
    ...
    def check_system_dependencies(self) -> bool:
        ...
        if missing:
            ...
            self.log("Please install the missing dependencies and try again", "ERROR")
            return False
    ...
    def setup_environment_file(self) -> bool:
        ...
        try:
            ...
            self.log("IMPORTANT: Please review and customize the .env file for your environment", "WARNING")
            return True
        except Exception as e:
    ...
    def check_database_connection(self) -> bool:
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                self.log("Database connection failed - this is normal if database is not running", "WARNING")
                return False
        except Exception as e:
