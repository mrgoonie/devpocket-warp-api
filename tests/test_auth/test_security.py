...
from app.auth.security import (
    ...
    decode_token, verify_token, blacklist_token, is_token_blacklisted,
    generate_password_reset_token, verify_password_reset_token,
    generate_secure_token, is_password_strong, set_redis_client
)
...
class TestSecurityEdgeCases:
    ...
    def test_decode_token_with_wrong_secret(self):
        ...
        wrong_secret_token = jose_jwt.encode(payload, "wrong_secret", algorithm=settings.jwt_algorithm)
