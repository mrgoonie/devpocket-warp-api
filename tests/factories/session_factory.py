...
class SessionFactory(factory.Factory):
    ...
    device_name = factory.LazyAttribute(lambda obj: {
        "ios": fake.random_element(["iPhone 15", "iPhone 14", "iPad Pro", "iPad Air"]),
        "android": fake.random_element(["Samsung Galaxy", "Google Pixel", "OnePlus", "Xiaomi"]),
    ...
    user_agent = factory.LazyAttribute(lambda obj: {
