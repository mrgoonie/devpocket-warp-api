...
class TestDbResetScript:
    ...
    def test_script_syntax_is_valid(self, script_runner):
        ...
        assert script_runner.check_script_syntax("db_reset.sh"), \
    ...
    def test_complete_reset_with_confirmation(self, mock_isfile, mock_input, mock_run, script_runner, mock_env):
    ...
    @patch('subprocess.run')
    @patch('os.path.isfile', return_value=True)
    def test_reset_with_force_flag(self, mock_isfile, mock_run, script_runner, mock_env):
    ...
    @patch('subprocess.run')
    @patch('os.path.isfile', return_value=True)
    def test_reset_with_force_short_flag(self, mock_isfile, mock_run, script_runner, mock_env):
    ...
    @patch('subprocess.run')
    @patch('os.path.isfile', return_value=True)
    def test_reset_with_custom_seed_type(self, mock_isfile, mock_run, script_runner, mock_env):
    ...
    @patch('subprocess.run')
    @patch('os.path.isfile', return_value=True)
    def test_reset_with_custom_seed_count(self, mock_isfile, mock_run, script_runner, mock_env):
    ...
    @patch('subprocess.run')
    @patch('os.path.isfile', return_value=True)
    def test_reset_no_verify_option(self, mock_isfile, mock_run, script_runner, mock_env):
    ...
    @patch('subprocess.run')
    @patch('os.path.isfile', return_value=True)
    def test_database_reset_failure(self, mock_isfile, mock_run, script_runner, mock_env):
    ...
    @patch('subprocess.run')
    @patch('os.path.isfile', return_value=True)
    def test_seeding_failure_continues(self, mock_isfile, mock_run, script_runner, mock_env):
    ...
    @patch('subprocess.run')
    @patch('os.path.isfile', return_value=True)
    def test_virtual_environment_activation(self, mock_isfile, mock_run, script_runner, mock_env):
    ...
    def test_status_script_creation(self, mock_file, mock_isfile, mock_run, script_runner, mock_env):
    ...
    @patch('os.path.isfile', return_value=True)
    @patch('builtins.open', new_callable=mock_open)
    def test_status_script_failure(self, mock_file, mock_isfile, mock_run, script_runner, mock_env):
    ...
    @patch('subprocess.run')
    @patch('os.path.isfile', return_value=True)
    def test_health_verification_failure(self, mock_isfile, mock_run, script_runner, mock_env):
    ...
    @patch('subprocess.run')
    @patch('os.path.isfile', return_value=True)
    def test_script_permissions_setup(self, mock_isfile, mock_run, script_runner, mock_env):
    ...
    @patch('subprocess.run')
    @patch('os.path.isfile', return_value=True)
    def test_complete_operation_sequence(self, mock_isfile, mock_run, script_runner, mock_env):
        ...
        expected_calls = [
            call(['python', mock_run.call_args_list[0][0][1], 'reset'], cwd=mock_run.call_args_list[0][1]['cwd'], env=mock_run.call_args_list[0][1]['env']),
        ]
