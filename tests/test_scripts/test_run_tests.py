...
class TestRunTestsScript:
    ...
    def test_script_syntax_is_valid(self, script_runner):
        ...
        assert script_runner.check_script_syntax("run_tests.sh"), \
    ...
    def test_run_all_tests_default(self, mock_file, mock_makedirs, mock_run, script_runner, mock_env):
    ...
    @patch('subprocess.run')
    @patch('os.makedirs')
    def test_run_unit_tests_only(self, mock_makedirs, mock_run, script_runner, mock_env):
    ...
    @patch('subprocess.run')
    @patch('os.makedirs')
    def test_run_integration_tests(self, mock_makedirs, mock_run, script_runner, mock_env):
    ...
    @patch('subprocess.run')
    @patch('os.makedirs')
    def test_run_specific_test_path(self, mock_makedirs, mock_run, script_runner, mock_env):
    ...
    @patch('subprocess.run')
    @patch('os.makedirs')
    def test_run_without_coverage(self, mock_makedirs, mock_run, script_runner, mock_env):
    ...
    @patch('subprocess.run')
    @patch('os.makedirs')
    def test_skip_database_check(self, mock_makedirs, mock_run, script_runner, mock_env):
    ...
    @patch('subprocess.run')
    @patch('os.makedirs')
    def test_pytest_execution_failure(self, mock_makedirs, mock_run, script_runner, mock_env):
    ...
    @patch('subprocess.run')
    @patch('os.makedirs')
    def test_clean_before_running(self, mock_makedirs, mock_run, script_runner, mock_env):
    ...
    def test_all_test_types(self, mock_makedirs, mock_run, script_runner, mock_env):
        ...
        valid_types = [
            ...
            "auth", "database", "services", "security", 
    ...
    @patch('subprocess.run')
    @patch('os.makedirs')
    def test_virtual_environment_activation(self, mock_makedirs, mock_run, script_runner, mock_env):
    ...
    @patch('subprocess.run')
    @patch('os.makedirs')
    def test_test_environment_setup(self, mock_makedirs, mock_run, script_runner, mock_env):
    ...
    @patch('subprocess.run')
    @patch('os.makedirs')
    def test_reports_directory_creation(self, mock_makedirs, mock_run, script_runner, mock_env):
    ...
    @patch('os.makedirs')
    @patch('builtins.open', new_callable=mock_open)
    def test_database_check_script_creation(self, mock_file, mock_makedirs, mock_run, script_runner, mock_env):
    ...
    @patch('subprocess.run')
    @patch('os.makedirs')
    def test_pytest_command_construction(self, mock_makedirs, mock_run, script_runner, mock_env):
    ...
    @patch('subprocess.run')
    @patch('os.makedirs')
    def test_coverage_report_paths(self, mock_makedirs, mock_run, script_runner, mock_env):
    ...
    @patch('subprocess.run')
    @patch('os.makedirs')
    def test_html_and_junit_reports(self, mock_makedirs, mock_run, script_runner, mock_env):
    ...
    def test_test_summary_with_reports(self, mock_isfile, mock_makedirs, mock_run, script_runner, mock_env):
    ...
    def test_parallel_execution_cpu_detection(self, script_runner):
        ...
        with patch('os.cpu_count', return_value=8):
            with patch('subprocess.run') as mock_run:
                ...
                with patch('shutil.which', return_value='/usr/bin/pytest'):
                    result = script_runner.run_script("run_tests.sh", ["-p", "--no-db-check"])
