...
def mock_database():
    ...
    class MockDatabase:
        def __init__(self):
            ...
            self.tables = ["users", "ssh_profiles", "commands", "sessions", "sync_data"]
...
def script_assertions():
    ...
    class ScriptAssertions:
        @staticmethod
        def assert_script_success(result: subprocess.CompletedProcess, 
        ...
        @staticmethod
        def assert_script_failure(result: subprocess.CompletedProcess,
