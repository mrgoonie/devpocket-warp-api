...
class RateLimitStore:
    ...
    def add_request(self, key: str, window: int = 60, limit: int = 100) -> Tuple[bool, int, int]:
        """
...
class RateLimitConfig:
    ...
    @classmethod
    def get_limit(cls, endpoint_type: str, subscription_tier: Optional[str] = None) -> int:
        """
...
class RateLimitMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next) -> Response:
        ...
        try:
            ...
            self._add_rate_limit_headers(response, current_count, remaining, endpoint_type)
    ...
    def _check_ip_rate_limit(self, ip: str, endpoint_type: str) -> Tuple[bool, int, int]:
        """
