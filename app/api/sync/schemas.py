...
class SyncDataRequest(BaseModel):
    ...
    last_sync_timestamp: Optional[datetime] = Field(None, description="Last synchronization time")
...
class SyncDataResponse(BaseModel):
    ...
    data: Dict[str, List[Dict[str, Any]]] = Field(..., description="Synchronized data by type")
    ...
    conflicts: List[Dict[str, Any]] = Field(default=[], description="Synchronization conflicts")
...
class SyncConflictResolution(BaseModel):
    ...
    resolved_data: Optional[Dict[str, Any]] = Field(None, description="Resolved data if using merge")
