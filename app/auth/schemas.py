...
class UserSettings(BaseModel):
    ...
    terminal_theme: str = Field(
        default="dark",
        description="Terminal color theme preference"
    )
    ...
    ai_suggestions_enabled: bool = Field(
        default=True,
        description="Whether AI suggestions are enabled"
    )
    ai_explanations_enabled: bool = Field(
        default=True,
        description="Whether AI explanations are enabled"
    )
    sync_enabled: bool = Field(
        default=True,
        description="Whether cross-device sync is enabled"
    )
    sync_commands: bool = Field(
        default=True,
        description="Whether command history sync is enabled"
    )
    sync_ssh_profiles: bool = Field(
        default=True,
        description="Whether SSH profile sync is enabled"
    )
...
class APIKeyValidationResponse(BaseModel):
    ...
    remaining_credits: Optional[float] = Field(
        None,
        description="Remaining credits (if available)"
    )
