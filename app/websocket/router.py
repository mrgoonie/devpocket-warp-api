...
async def terminal_websocket(
    ...
    try:
        ...
        logger.info(f"WebSocket terminal connection established: user_id={user_id}, connection_id={connection_id}")
        ...
        while True:
            try:
                ...
                logger.warning(f"Invalid JSON from WebSocket client {connection_id}: {e}")
