...
class SSHHandler:
    ...
    async def connect(self) -> Dict[str, Any]:
        ...
        """
        try:
            logger.info(f"Connecting to SSH: {self.ssh_profile.username}@{self.ssh_profile.host}:{self.ssh_profile.port}")
            ...
            if transport:
                self.server_info = {
                    ...
                    "cipher": transport.get_cipher()[0] if transport.get_cipher() else "unknown",
