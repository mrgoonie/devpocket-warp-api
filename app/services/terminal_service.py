...
class TerminalService:
        ...
        try:
            ...
            for session in sessions:
                session_info = {
                    ...
                    "is_connected": session.id in connection_manager.session_connections
                }
    ...
    async def terminate_session(self, session_id: str, user_id: str) -> bool:
        ...
        try:
            ...
            if not session or session.user_id != user_id:
                logger.warning(f"Unauthorized session termination attempt: {session_id} by {user_id}")
                return False
    ...
    async def get_connection_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            for conn_id, connection in list(connection_manager.connections.items())[:10]:
                conn_details = {
